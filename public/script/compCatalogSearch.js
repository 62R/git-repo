Vue.component('comp-catalog-search', {
    ...
    template: `
        ...
        <button :class="buttonClass" type="button" @click="filterShow = !filterShow">
                <svg v-show="!filterShow" width="27" height="28" viewBox="0 0 27 28"
            ...
            <transition name="catalog-search">
                <div class="catalog-search" v-show="filterShow">
                    ...
                    <button :class="buttonClass" type="button" @click="filterShow = !filterShow">                
                    <svg v-show="filterShow" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                        viewBox="0 0 18 18">
                        <path
